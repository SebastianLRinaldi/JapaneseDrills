...
class RecallTracker:
    ...
    def init_mastery_file(self):
        ...
        self.master_words_list = [w for w in self.master_words]
    ...
    def add_session(self, session_duration, untracked_words, tracked_words):
        ...
        session_data = {
            ...
            "total_count": len(untracked_words + tracked_words),
    ...
    def update_master(self):
        ...
        self.master_words.update(dict(sorted(self.master_words.items(), key=lambda x: x[1]["count"])))
