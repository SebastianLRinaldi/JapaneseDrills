...
from src_old.apps.VocabRanomizer.WordTypeFunctions.verbs import VerbsLogic
from src_old.apps.VocabRanomizer.WordTypeFunctions.nouns import NounsLogic
from src_old.apps.VocabRanomizer.WordTypeFunctions.adjectives import AdjectivesLogic
from src_old.apps.VocabRanomizer.WordTypeFunctions.grammar import GrammarLogic


class Logic:
    def __init__(self, ui: Layout):
        self.ui = ui
        self.verbs_logic = VerbsLogic(self.ui)
        self.nouns_logic = NounsLogic(self.ui)
        self.adjectives_logic = AdjectivesLogic(self.ui)
        self.grammar_logic = GrammarLogic(self.ui)


    def update_lists(self):
        self.nouns_logic.update_nouns()
        self.adjectives_logic.update_adjectives()
        self.verbs_logic.update_verbs()
        self.grammar_logic.update_grammar()


    def update_list_random(self):
        self.nouns_logic.update_nouns_random()
        self.adjectives_logic.update_adjectives_random()
        self.verbs_logic.update_verbs_random()
        self.grammar_logic.update_grammar_random()
