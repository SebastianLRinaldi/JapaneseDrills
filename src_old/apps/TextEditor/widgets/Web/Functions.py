...
from src_old.apps.ConjugationDrill.widgets.Web.Layout import Layout as Layout
...
class Logic:
    ...
    def click_element(self, xpath):
            ...
            """
            self.execute_js(xpath, click_script)
    ...
    def type_text(self, xpath, text_to_type):
        ...
        element.focus();
        // Optionally, trigger input events so the app knows content changed
    ...
    def send_input_to_web(self, text):
        self.type_text("//div[@id='prompt-textarea']", text)

    def enter_text(self):
        self.click_element("//button[@id='composer-submit-button']")
