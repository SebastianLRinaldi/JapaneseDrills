...
from src_old.apps.SentenceChunks.Layout import Layout, ChunkInput
...
class Logic:
    ...
    def update_widget(self) -> None:
        self.ui.example_label.setText("Im on 1, I have been updated by 1!")

    def reset_widget(self) -> None:
        self.ui.example_label.setText("Im on 1, I have been reset by 1!")

    def show_context_menu(self, pos: QPoint):
        menu = QMenu()

        add_row_above_action = QAction("Add 1 Left", self.ui.chunk_holder)
        add_row_above_action.triggered.connect(self.add_row_above)
        menu.addAction( add_row_above_action)

        
        add_row_action = QAction("Add 1 Right", self.ui.chunk_holder)
        add_row_action.triggered.connect(self.add_row_below)
        menu.addAction(add_row_action)


        remove_row_action = QAction("Remove Chunk", self.ui.chunk_holder)
